...
public final class ExtensionLoader<T> {
    ...
    public List<T> getActivateExtension(String values, String group) {
        ...
        List<String> names = values == null ? new ArrayList<>(0) : Arrays.asList(StringUtils.split(values, ","));
        ...
        for (Map.Entry<String, Object> entry : cachedActivates.entrySet()) {
            ...
            if (isMatchGroup(group, new HashSet<>(Arrays.asList(activateGroup))) && names.contains(name)){
